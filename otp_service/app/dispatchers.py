...
async def dispatch_email(*, settings: Settings, recipient: str, subject: str, body: str) -> None:
    ...
    LOGGER.info("Simulating OTP email delivery to %s (Mailpit disabled).", recipient)
    LOGGER.info("Subject: %s", subject)
    LOGGER.info("Body:%s%s", "\n", body)

    # The following block is intentionally commented out to avoid real email dispatches
    # via Mailpit during demo sessions. Uncomment to re-enable SMTP-based delivery.
